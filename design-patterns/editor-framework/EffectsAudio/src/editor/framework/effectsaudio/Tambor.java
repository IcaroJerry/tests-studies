 ...
 * @author ICAROJ
 */
public class Tambor extends IDocumentDecorator{

    public Tambor(IDocument imagedecored) {
        super(imagedecored);
    ...
    public String getName() {
      return Tambor.class.getSimpleName();
    }
   
    @Override
    public void setDocument(IDocument doc) {
        ICore.getInstance().getProjectController().setCurrentDocument((IDocument)new Tambor(doc));
