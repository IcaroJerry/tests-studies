 ...
 * @author ICAROJ
 */
public class Tiroteio extends IDocumentDecorator{

    public Tiroteio(IDocument imagedecored) {
        super(imagedecored);
    ...
    public String getName() {
      return Tiroteio.class.getSimpleName();
    }
   
    @Override
    public void setDocument(IDocument doc) {
        ICore.getInstance().getProjectController().setCurrentDocument((IDocument)new Tiroteio(doc));
