 ...
 * @author ICAROJ
 */
public class PorDoSol extends IDocumentDecorator{

    public PorDoSol(IDocument imagedecored) {
        super(imagedecored);
    ...
    public void setDocument(IDocument doc) {
        ICore.getInstance().getProjectController().setCurrentDocument((IDocument)new PorDoSol(doc));
