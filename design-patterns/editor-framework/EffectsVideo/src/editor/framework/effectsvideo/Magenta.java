 ...
 * @author ICAROJ
 */
public class Magenta extends IDocumentDecorator{

    public Magenta(IDocument imagedecored) {
        super(imagedecored);
    ...
    public void setDocument(IDocument doc) {
        ICore.getInstance().getProjectController().setCurrentDocument((IDocument)new Magenta(doc));
