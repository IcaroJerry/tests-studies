 ...
 * @author ICAROJ
 */
public class BarrilDobrado extends IDocumentDecorator{

    public BarrilDobrado(IDocument imagedecored) {
        super(imagedecored);
        this.nameDocument(this.getName());
    }
    
    public BarrilDobrado() {
       super(null);
    }
    ...
    public void setDocument(IDocument doc) {
        ICore.getInstance().getProjectController().setCurrentDocument((IDocument)new BarrilDobrado(doc));
