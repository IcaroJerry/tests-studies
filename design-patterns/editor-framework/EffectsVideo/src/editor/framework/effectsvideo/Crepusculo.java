 ...
 * @author ICAROJ
 */
public class Crepusculo extends IDocumentDecorator{

    public Crepusculo(IDocument imagedecored) {
        super(imagedecored);
    ...
    public void setDocument(IDocument doc) {
        ICore.getInstance().getProjectController().setCurrentDocument((IDocument)new Crepusculo(doc));
